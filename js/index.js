$(window).on('load',function(){
  ...
  // Check if mobile device (width <= 1025px)
  if (window.innerWidth <= 1025) {
    // Mobile: Show all sections for scrolling
    ...
    // Desktop: Normal single-page behavior
    gsap.to('#header',0,{display:"block",delay:1})
    gsap.to('#navigation-content',0,{display:"none"});
...
$(function(){
    ...
    $('#about-link').on('click',function(){
      // Skip navigation on mobile - all sections are visible for scrolling
      if (window.innerWidth > 1025) {
